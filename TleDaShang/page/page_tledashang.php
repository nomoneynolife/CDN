...
<div class="container" style="padding-top:20px;">
	<div class="col-xs-12 col-sm-10 col-lg-8 center-block" style="float: none;">
		...
		<p style="text-align:center"><br>&copy; <?=date("Y");?> <a href="<?=$this->options ->siteUrl();?>" target="_blank"><?php $this->options->title();?></a> and Plugin By <a href="http://onlinebeg.tk" target="_blank">onlinebeg</a>. All rights reserved.</p>
	</div>
</div>
